...
public class MemberController {
	...
	private static final Logger logger 
		...
		private String postRegister(MemberDTO memberDTO) throws Exception{
			...
			//회원정보수정GET
			@RequestMapping(value="/member/proUpdate",method=RequestMethod.GET)
			private String getUpdateView() throws Exception{
				
				logger.info("MemberController getUpdate");
				
				return "/member/proUpdate";
			}//end - private String getUpdateView() throws Exception
			
			//회원정보수정POST
			@RequestMapping(value="/member/proUpdate",method=RequestMethod.POST)
			...
			//회원정보삭제GET
			@RequestMapping(value="/member/proDelete",method=RequestMethod.GET)
			private String getDeleteView() throws Exception{
				
				logger.info("MemberController getDelete");
				
				return "/member/proDelete";
			}//end - private String getDeleteView() throws Exception
			
			//회원정보삭제POST
			@RequestMapping(value="/member/proDelete",method=RequestMethod.POST)
			private String postDelete(MemberDTO memberDTO, HttpSession session, RedirectAttributes rttr) throws Exception{
				...
				if(!sessionPasswd.equals(memberDTOPasswd)) {
					rttr.addFlashAttribute("msg", false);
					return "redirect:/member/proDelete";
				}
