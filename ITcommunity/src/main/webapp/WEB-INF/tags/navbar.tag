	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="myNavbar">
			<ul class="nav navbar-nav navbar-right">
				...
				<c:if test="${member != null}">
				<li><p><font color="#000066">${member.userId}님 안녕하세요!</font></p></li>
				</c:if>
				
				<c:if test="${member != null}">
					<li><a href="/qna/qnaList" class="qnaList">QnA</a></li>
					<li><a href="/community/communityList" class="communityList">COMMUNITY</a></li>
				</c:if>
			    ...
			    <c:if test="${member != null}">
			    	<li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">MY PAGE<span class="caret"></span></a>
        				<ul class="dropdown-menu">
          					<li><a href="/member/proUpdate">회원정보수정</a></li>
          					<li><a href="/member/proDelete">회원탈퇴</a>
        				</ul>
      				</li>
			    </c:if>
			    ...
			    <c:if test="${member != null}">
			     	<li><a href="/member/logout" role="button"><span class="glyphicon glyphicon-log-out"></span> LOGOUT</a></li>
			    </c:if>
