...
<head>
<meta charset="UTF-8">
<title>communityInsert.jsp</title>
</head>
<body>
<div class="container-fluid">
	<h2 align="left">게 시 글 작 성</h2>
	<form class="form-horizontal" action="/community/insertProc" method="post">
	
		<div class="form-group">
		<label class="control-label col-sm-2">분류 선택</label>
		<div class="col-sm-2">
			<select class="form-control" name="boardchoice">
					<option value="100">공지글</option>
					<option value="200">비밀글</option>
			</select>
			</div>
		</div>
		<div class="form-group">
