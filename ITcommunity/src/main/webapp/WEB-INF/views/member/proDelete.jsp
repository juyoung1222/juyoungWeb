...
<title>proDelete.jsp</title>
</head>
<body>
<div class="container-fluid">
	<form class="form-horizontal" method="post" action="/member/proDelete">
	...
	<c:if test = "${msg == false}">
		<div class="form-group">
			<div class="col-sm-8">
				<h3><span class="label label-danger">회원탈퇴에 실패하였습니다. 비밀번호를 다시 입력하세요</span></h3>
			</div>
		</div>
	</c:if>
</form>
