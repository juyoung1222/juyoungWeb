...
<div class="container">
	...
	<div class="form-group">
		<label class="control-label col-sm-3"><span class="glyphicon glyphicon glyphicon glyphicon-user">성 별</span></label>
...
$(document).ready(function() {
	...
	$("#submit").on("click",function(){
		if($("#userId").val() == ""){
			alert("아이디를 입력하세요 아이디는 영문자, 숫자 혼용해서 사용하셔야 합니다.");
			$("#userId").focus();
			return false;
		}
		if($("#userPw").val() == ""){
			alert("비밀번호를 입력하세요 비밀번호는 영문자,숫자 혼용해서 사용하셔야 합니다.");
			$("#userPw").focus();
			return false;
		}
		if($("#userName").val() == ""){
