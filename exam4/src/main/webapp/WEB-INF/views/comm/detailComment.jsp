...
<div class="container">
	...
	<div class="col-xs-12">
		...
		<div class="btn-group btn-group-sm" role="group" style="float:right;">
			<button type="button" class="btn btn-info"    onclick="location.href='/comm/commDelete/${detail.bno}'">삭제</button>
			<button type="button" class="btn btn-success" onclick="location.href='/comm/commUpdate/${detail.bno}'">수정</button>
			<button type="button" class="btn btn-danger " onclick="location.href='/comm/commList'">목록</button>
		</div>
	</div>
