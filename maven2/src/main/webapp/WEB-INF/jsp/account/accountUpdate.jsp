...
function setBox(sParam){
	alert("ajax시작!");
	alert("account_seq" : $("#account_seq"));
	//var project = $('#profitCost');
	//var select = $("#profitCost");
	//var select = $('#bigGroup');
	//var select1 = $('#middleGroup');
	//var select2 = $("#smallGroup");
	//var select3 = $("#comment1");
	...
	$.ajax({
		...
		type : 'post',
		dataType : 'json',
		data : {'select' : select, 'select1' : select, 'select2' : select2,
		...
		success : function(data){
			...
			//for(var i =0 ; i< data.Map.size; i++){
				...
				alert("option 이지롱");
				 //$('#bigGroup').append('<option value=" ${'+resultMap.code+'}">${'+ resultMap.comKor +'}</option>');
				 //$('#bigGroup').append('<option value="'+ data[i].code+ '">' + data[i].comKor + '</option>');
				 //$('#middleGroup').append('<option value="'+ singunguCode.code+ '">' +singunguCode.comKor + '</option>');
				 //$('#smallGroup').append('<option value="'+ singunguCode.code+ '">' + singunguCode.comKor + '</option>');
				 //$('#comment1').append('<option value="'+ singunguCode.code+ '">' + singunguCode.comKor + '</option>');
				...
				// $("<input>", {type : 'text'}).appendTo($("#account_seq"));
				 ...
				 alert("bbbb");
				 //$(select1).append('<option value="'+ data[i].code+ '">' + data[i].comKor + '</option>');
				 //$(select2).append('<option value="'+ data[i].code+ '">' + data[i].comKor + '</option>');
				 //$(select3).append('<option value="'+ data[i].code+ '">' + data[i].comKor + '</option>');
			...
			//$('#profitCost').html(choice);
			
			
			
			//$(project).find("option").remove().end().append("<option value="">선택</option>");
			...
			<div class="col-sm-11">
			 		<div class="col-sm-12">
				      <div  id="profitCost" class="col-sm-3" >
				      	<input type="text" id="account_seq" value="${resultMap.account_seq}"/>
				...
				<div class="col-sm-12">  <label for="disabledInput" class="col-sm-12 control-label"> </label></div>
			 		<div class="col-sm-12">
				      ...
				      <div class="col-sm-3">
				        	<input class="form-control"  name="transaction_money" type="text" onkeypress = 'return checkNumber(event)' value="" title="금액">
				      </div>
			 		  <label for="disabledInput" class="col-sm-1 control-label"><font size="1px">거래일자</font></label>
				      <div class="col-sm-3">
				       	 <input class="form-contro col-sm-2"  name="transaction_date" type="date" value="" style="width: 80%" title="거래일자">
				      </div>
			 		</div>
