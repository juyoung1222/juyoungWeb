...
<div class="form-group">
	...
	<div class="col-sm-6">
		<input type="text" class="form-control" id="productprice" name="productprice" value="${product.productprice}원" readonly="readonly"/>
	</div>
</div>
<div class="form-group">
...
<div class="form-group">
	<label class="control-label col-sm-2">이 미 지</label>
		<img src="/static/imagefile/OIP.jpg" alt="이미지업로드">
</div>
<div class="form-group">
...
<div class="form-group">
	<label class="control-label col-sm-2">할인 판매가격</label>
	<div class="col-sm-6">
		<input type="text" class="form-control" id="productdiscount" name="productdiscount" value="${Math.round(product.productprice * (100-product.productdiscount)/100) }원" readonly="readonly"/>
	</div>
</div>
<div class="form-group">
	<label class="control-label col-sm-2">상품 등록 일자</label>
	<div class="col-sm-6">
	...
	<select name="amount">
		<c:forEach begin="1" end="10" var="i">
			...
			<button type="button"  onclick="location.href='/cart/cartList'" class="btn btn-info">장바구니에 담기</button>
