...
<body>
<div class="container">
	<form class="form-horizontal" name="writerform" action="/product/updateProc"  method="post">
	<div class="form-group">
		<div class="col-sm-2"></div>
		<div class="col-sm-6">
			<h2 align="left">상 품 수 정</h2>
		</div>
		<div class="col-sm-3">
		...
		<label class="control-label col-sm-2">번호 </label>
			<div class="col-sm-4">
				<div class="input-group">
					<input type="text" class="form-control" value="${product.productno}" 
					id="productno" name="productno"  readonly="readonly"/>
				</div>
			</div>
		</div>
	<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-sm-4">
				<div class="input-group">
					<input type="text" class="form-control" value="${product.productprice}" maxlength="8" 
					id="productprice" name="productprice"  readonly="readonly"/>
		...
		<div class="form-group">
			...
			<div class="col-sm-2">
				<div class="input-group">
					...
					id="productsalescnt" name="productsalescnt" value="${product.productsalescnt}" readonly="readonly"/>
		...
		<div class="form-group">
			...
			<div class="col-sm-2">
				<div class="input-group">
					...
					id="productdiscount" name="productdiscount"  value="${product.productdiscount}" readonly="readonly"/>
		...
		<div class="col-sm-offset-2 col-sm-4">
			<button class="btn btn-success" type="submit" id="submit">상품수정</button>
...
//취소버튼을 눌렀을 경우
	...
	//상품수정 버튼을 눌렀을 경우 =>입력필드가 비어있는지 검사한다.
